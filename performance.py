...
def resource_usage(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        print(
            f"{func.__name__} used {usage_end.ru_maxrss - usage_start.ru_maxrss} kilobytes of memory"
        )
        return result
...
def cpu_timeit_detailed(func):
    ...
    def wrapper(*args, **kwargs):
        ...
        print(
            f"{func.__name__} took {(end - start) * 1000:.3f} milliseconds CPU seconds to run."
        )
        return result
